...
function ensureGlobalSearchItem(items: NavItem[]): NavItem[] {
  if (
    items.some(
      (item) =>
        item.id === GLOBAL_FUNCTION_SEARCH_ITEM.id || item.route.startsWith('/screens/app-search'),
    )
  ) {
    return items;
  }
...
const getDefaultNavItems = (role: string, options?: { adminHomeRoute?: string }): NavItem[] => {
  switch (role) {
    case 'teacher':
      return [
        { id: 'home', label: 'Dashboard', icon: 'home', route: '/screens/teacher-dashboard' },
        {
          ...
          label: 'Daily Routine',
          icon: 'today',
          route: '/screens/teacher-daily-program-planner',
        },
        ...
        },
        {
          ...
          icon: 'clipboard',
          route: '/screens/teacher-routine-requests',
        },
        ...
        },
        {
          ...
          route: '/screens/aftercare-activities',
        },
        {
          id: 'messages',
          label: 'Messages',
    ...
    case 'parent':
      return [
        ...
        },
        {
          ...
          icon: 'time',
          route: '/screens/parent-homework-history',
        },
        {
          id: 'announcements',
          label: 'Announcements',
        ...
        {
          id: 'aftercare',
          label: 'Register Aftercare',
          icon: 'school',
          route: '/screens/parent-aftercare-registration',
        },
        {
          id: 'upgrade',
          label: 'Upgrade Plan',
          icon: 'arrow-up-circle',
          route: '/screens/parent-upgrade',
        },
        {
          id: 'documents',
          label: 'Documents',
    ...
    case 'principal_admin':
      return [
        { id: 'home', label: 'Dashboard', icon: 'home', route: '/screens/principal-dashboard' },
        {
          ...
          icon: 'sparkles',
          route: '/screens/principal-daily-program-planner',
        },
        {
          id: 'year-planner-ai',
          label: 'AI Year Planner',
          icon: 'calendar-clear',
          route: '/screens/principal-ai-year-planner',
        },
        {
          id: 'routine-requests',
          label: 'Routine Requests',
          icon: 'clipboard',
          route: '/screens/principal-routine-requests',
        },
        { id: 'students', label: 'Students', icon: 'people', route: '/screens/student-management' },
        {
          id: 'teachers',
        ...
        },
        {
          ...
          icon: 'checkmark-done',
          route: '/screens/teacher-approval',
        },
        {
          id: 'registrations',
          label: 'Registrations',
        ...
        { id: 'campaigns', label: 'Campaigns', icon: 'megaphone', route: '/screens/campaigns' },
        {
          ...
          label: 'Timetable',
          icon: 'time',
          route: '/screens/timetable-management',
        },
        {
          id: 'staff-leave',
          label: 'Staff Leave',
          icon: 'calendar',
          route: '/screens/staff-leave',
        },
        { id: 'waitlist', label: 'Waitlist', icon: 'list', route: '/screens/waitlist-management' },
        {
          ...
          route: '/screens/compliance-dashboard',
        },
        ...
        { id: 'reports', label: 'Reports', icon: 'analytics', route: '/screens/teacher-reports' },
        {
          ...
          label: 'Calendar',
          icon: 'calendar',
          route: '/screens/calendar-management',
        },
        { id: 'settings', label: 'Settings', icon: 'settings', route: '/screens/settings' },
      ];
    case 'admin':
      return [
        {
          ...
          label: 'Dashboard',
          icon: 'home',
          route: options?.adminHomeRoute || '/screens/org-admin-dashboard',
        },
        ...
        },
        {
          ...
          label: 'Data Import',
          icon: 'cloud-upload',
          route: '/screens/org-admin/data-import',
        },
        {
          id: 'settings',
          label: 'Settings',
...
export function MobileNavDrawer({ isOpen, onClose, navItems }: MobileNavDrawerProps) {
  ...
  const adminHomeRoute =
    userRole === 'admin'
      ...
      : undefined;
  const items = ensureGlobalSearchItem(
    navItems || getDefaultNavItems(userRole, { adminHomeRoute }),
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                <Ionicons
                  name={
                    (active || item.icon.startsWith('logo-') || item.icon.endsWith('-outline')
                      ? item.icon

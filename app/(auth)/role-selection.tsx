...
const INDIVIDUAL_ROLES: RoleOption[] = [
  {
    ...
    description:
      "Monitor your children's progress, communicate with teachers, and stay connected with their school",
    icon: 'people-outline',
  ...
  },
  {
    ...
    description:
      'Join programs, track your progress, submit assignments, and access learning materials',
    icon: 'school-outline',
...
const ORGANIZATION_ROLES: RoleOption[] = [
  {
    ...
    description:
      'Preschools, primary schools, high schools - set up your institution on EduDash Pro',
  ...
  },
  {
    ...
    description:
      'Training centers, skills development programs, adult education, or tertiary institutions',
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <Text style={styles.title}>
            {t('auth.role_selection.heading', { defaultValue: 'How will you use EduDash Pro?' })}
          </Text>
          <Text style={styles.subtitle}>
            {t('auth.role_selection.subheading', {
              defaultValue: 'Choose the option that best describes your role',
            })}
          </Text>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>
              {t('auth.role_selection.individuals', { defaultValue: 'Join a School or Program' })}
            </Text>
          </View>
          <Text style={styles.sectionHint}>
            {t('auth.role_selection.individuals_hint', {
              defaultValue: 'For parents, students, and educators joining an existing school',
            })}
          </Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>
              {t('auth.role_selection.organizations', { defaultValue: 'Start an Organization' })}
            </Text>
          </View>
          <Text style={styles.sectionHint}>
            {t('auth.role_selection.organizations_hint', {
              defaultValue: 'For principals, admins, and organization leaders',
            })}
          </Text>
        ...
        <View style={styles.helpSection}>
          ...
          <Text style={styles.helpText}>
            {t('auth.role_selection.help', {
              defaultValue:
                'Not sure which to choose? Parents and students typically join existing schools. School principals and org admins create new organizations.',
            })}
          </Text>
        </View>

...
export const s = StyleSheet.create({
  ...
  headerBtn: { padding: 8 },
  headerCenter: { flex: 1, alignItems: 'flex-start', justifyContent: 'center', minWidth: 0 },
  ...
  headerTitle: { fontSize: 18, fontWeight: '700', textAlign: 'left' },
  headerSub: { fontSize: 12, marginTop: 2, textAlign: 'left' },

...
export function buildSystemPrompt(
  ...
  parts.push(
    ...
    '- You MAY use markdown formatting (bold, headers, bullet points) — it will be shown in the chat and automatically stripped before speaking.',
  ...
  parts.push(
    ...
    '- Write complete math expressions on a SINGLE line. Never split across lines.',
    '- CORRECT: $5^3 = 5 \\times 5 \\times 5 = 125$',
    '- WRONG: putting "5 \\times" on one line and "5 \\times 5 = 125" on the next.',
    '- Use $...$ for inline math and $$...$$ for display equations.',
    '- Do NOT use \\\\ (double backslash line breaks) inside simple expressions.',
    '- In South Africa, say "to the power of" not "caret" or "hat".',
    '- Example: "five to the power of three" not "five caret three".',
    '',
    'IMAGE GENERATION:',
